...
public class Pruefungsaenderung_result extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String strInsert = "Update CHRISTIANMARSAL.PRUEFUNG "
							+ "SET ART = '"+pruefungsart+"', PRUEFUNGSBEGINN = "+pruefungsbeginn+", PRUEFUNGSENDE = "+pruefungsende+", ANMELDEFRIST = "+anmeldefrist+", ABMELDEFRIST = "+abmeldefrist+" "
			...
			sb.append("<h2>Prüfungsänderung</h2>\n" + 
					"<p>Die Prüfungsänderung wurde erfolgreich durchgeführt.</p></br>\n" + 
					"<form action=\"../Prüfungsänderung\" method=\"get\">\n" +
					HtmlBuilder.createSubmitButton("Zurück zur Prüfungsänderung") + 
					"</form>");
			// end of appends //
