...
public class Pruefungsloeschung_result extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String strDelete = "Delete from CHRISTIANMARSAL.PRUEFUNG WHERE id="+pruefungsid;       
			...
			sb.append("<h2>Prüfungslöschung</h2>\n" + 
					"<p>Die Prüfung und alle zugehörigen Anmeldungen wurden erfolgreich gelöscht.</p></br>\n" + 
					"<form action=\"../Prüfungslöschung\" method=\"get\">\n" +
					HtmlBuilder.createSubmitButton("Zurück zur Prüfungslöschung") +
					"</form>");
			// end of appends //
