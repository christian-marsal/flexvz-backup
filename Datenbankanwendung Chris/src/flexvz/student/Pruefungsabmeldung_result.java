...
public class Pruefungsabmeldung_result extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String strDelete = "Delete from CHRISTIANMARSAL.PRUEFUNGSANMELDUNG WHERE pruefungsid="+pruefungsid+"AND studentenid="+MainPage.matrikelnummer;       
			...
			sb.append("<h2>Prüfungsabmeldung</h2>\n" + 
					"<p>Die Prüfungsabmeldung wurde erfolgreich durchgeführt.</p></br>\n" + 
					"<form action=\"../Prüfungsabmeldung\" method=\"get\">\n" +
					HtmlBuilder.createSubmitButton("Zurück zur Prüfungsabmeldung") +
 					"</form>");
