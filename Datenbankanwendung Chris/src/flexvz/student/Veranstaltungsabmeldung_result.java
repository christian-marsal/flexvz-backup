...
public class Veranstaltungsabmeldung_result extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String strDelete = "Delete from CHRISTIANMARSAL.TEILNEHMERLISTE WHERE veranstaltungsid="+veranstaltungsid+"AND studentid="+MainPage.matrikelnummer;       
			...
			sb.append("<h2>Veranstaltungsabmeldung</h2>\n" + 
					"<p>Die Veranstaltungsabmeldung wurde erfolgreich durchgeführt.</p></br>\n" + 
					"<form action=\"../Veranstaltungsabmeldung\" method=\"get\">\n" +
					HtmlBuilder.createSubmitButton("Zurück zur Veranstaltungsabmeldung") +
					"</form>");
